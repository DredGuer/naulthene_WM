...
| Ticks passés en gestes qui ne changent rien (`Empty-5x5`) | **57,2 %** — `poser`/`activer`/`parler` sont stériles à **100 %** et coûtent **1,09** contre **4,00** pour le seul geste qui rapproche du but |
