...
| 🔴 **v41.36 — la tête poursuit une cible mobile** | Tout fonctionne : le tronc **amplifie** la caractéristique décisive (d' 0,824 → 2,891/3,613/3,017), le gradient arrive (0,234/0,056), **g22 n'est jamais clippé** (0/5 nuits), Adam fait son pas plein (0,93 % de \|W\| par 5 nuits), la nuit n'érode pas (norme à **90–98 %** de la naissance), et les pas sont **dirigés** (\|cos(ΔW, axe)\| jusqu'à **9,1× le hasard**) et **cumulatifs** (alignement temporel **0,969** contre 0,316 pour une marche aléatoire). Mais l'axe informatif — défini dans `pensee_bio`, entraîné *en même temps* — **tourne de 4,81°/nuit** quand `W` s'en rapproche de 0,106°/nuit : la cible fuit **14× à 46× plus vite** que le poursuivant. **Dérive de représentation**, jamais mesurée ici |
