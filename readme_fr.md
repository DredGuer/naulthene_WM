...
| **Le plafond est-il un plancher géométrique ?** | ✅ **Non — mesuré le 30/08/2026.** Sur `SimpleCrossingS9N1` un marcheur aléatoire fait **5,67 %** (600 épisodes : 4,50 %, IC95 [3,1 ; 6,5]) quand les cerveaux entraînés atteignent **25,83 %** agrégé (`z = +13,56`), et l'un d'eux **37,33 %** — dans la fourchette de PPO (27–40 %). **La compétence est réelle.** ⚠️ Mais les victoires restent **browniennes** : 14,2× à 18,1× le plus court chemin (trajet optimal médian **12 pas**, budget 324 ticks), et `r(succès, directivité) = −0,92`. L'agent gagne bien plus souvent que le hasard sans jamais parcourir une trajectoire dirigée. 🟡 Un quatrième constat est **inexpliqué et sans valeur à n = 4** : le succès au banc est *inversement* ordonné à la maîtrise en run (`r = −0,89`, `t = −2,72` contre un seuil de 4,30) |
