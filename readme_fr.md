...
| Effet de couper C2 sur le score | **0,0 point sur les 6 niveaux** (78 cellules) — et sur `LavaGap`, le couper **triple** la réussite. 🔴 **RÉSULTAT CONFONDU (05/09/2026)** : la lésion `c2_coupe` pose `force_planification = 0`, ce qui plaque `gain_c1` à sa borne basse **0,25** — elle coupait C2 **et étranglait C1 à un quart**. Elle n'existe par ailleurs **que dans le banc**, jamais dans le cursus. Ablation propre (`--sans-c2`, v41.57) **en cours** |
