...
- Ne jamais masquer l'état réel. **Mise à jour du 20/08/2026 (campagne v41.29, 10 graines ×
  ...
  0,0 point sur les 6 niveaux** (78 cellules d'ablation — ⚠️ **CE RÉSULTAT ÉTAIT CONFONDU, ET IL SURVIT QUAND MÊME (05/09/2026)** : la lésion `c2_coupe` du banc posait `force_planification = 0`, ce qui plaquait `gain_c1` à **0,25** — elle coupait C2 **et étranglait C1**. Refaite proprement avec `--sans-c2` (v41.57, `gain_c1` intact), la conclusion **tient** : δ maîtrise **−1,375 pt** (`t` = −1,15, NS, **5/20**), effet minimal détectable **3,42 pt**. **C2 est INERTE.** ⚠️ Le juge « niveau » est **SATURÉ** (40 runs au plafond du niv. 4) — c'est la maîtrise qui porte la réponse. Le vrai levier est la **renormalisation de C1** : **20/20** au niveau 4 contre **1/20** au témoin (`t` = +19,00). Voir `docs/recherche/campagnes/ABLATION_C2_05092026_l_organe_muet.md`.) ⚠️ Ces taux sont à **n=10, sous le
