...
|---|---|
| **[EVA01_13092026](recherche/campagnes/EVA01_13092026_la_derivation_de_n.md)** | ✅ **LE `n` DU BANC EST DÉRIVÉ, ET IL VAUT 333** (pilote, pas une campagne à n≥20 : 4 cerveaux `K8_NU` × 2 cartes figées × 20 épisodes = 160 épisodes, lecture seule, A/A **160/160 identiques**). `p̄` = **0,2563** (41/160), dispersion inter-cerveaux `sd_inter` = **0,0718**, **IC95 = [0,041 ; 0,268]** — un facteur **43** sur le `n` impliqué (24 à 1037 épisodes). ⚠️ La dispersion **poolée** (0,072) est plus PETITE que chacune des deux dispersions par carte (0,108 et 0,170, ρ inter-cartes = **−0,54**) : le choix poolé est ici le plus conservateur (333 vs 176 vs 43). 🔴 **Fait nouveau, trouvé en vérifiant** : la `trajectoire` publiée par le banc perd le but sur **8 victoires sur 41** (lecture post-`trajectoire` d'un épisode déjà réenchaîné) — aucun chiffre du pilote n'en dépend, mais l'artefact d'audit est muet sur le pas décisif. Coût projeté de la tâche 9 à `n = 333` : **≈ 10,5 h** (6 bras × 20 graines × 2 cartes) |
