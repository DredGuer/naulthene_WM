...
Ce document se lit en parallèle de [explications_readme.md](explications_readme.md) : chaque
...
cf. [explications_readme §1](explications_readme.md)), et le run en apporte une démonstration
...
- La **promotion de niveau** (`VICTOIRES_REQUISES=2`, [explications §11.1](explications_readme.md))
...
- Mais les **7 paliers DoorKey** (`DetecteurJalonsDoorKey`, [explications §11.3](explications_readme.md))
...
> [explications §1](explications_readme.md)) est *« ne pas optimiser un seul chiffre récompense,
...
([explications §2.2](explications_readme.md)). Le prédicteur `generateur_attente` et l'encodeur
...
([explications §8, §9, §10](explications_readme.md)) :
...
[explications §8.2](explications_readme.md)) raconte la même histoire : **7 100 dès le J240**
...
| **Sélection de l'information** | *Soft attention* apprise : le modèle **pondère** dynamiquement quels éléments du passé comptent | `lecture_episodique` = double reconcaténation avec un **contexte moyenné** (moyenne non pondérée, [explications §4](explications_readme.md)) | La moyenne glissante traite tous les souvenirs à poids égal. C'est précisément ce qu'un mécanisme d'attention remplacerait : *quel* souvenir est pertinent *maintenant*. Le plateau de compétence suggère que l'agent ne sait pas rappeler « où est la clé » au bon moment. |
...
Naulthène implémente fidèlement l'idée JEPA (prédire le latent, stop-gradient, [explications §2](explications_readme.md)).
...
C'est le cousin le plus proche du **Système 2** ([explications §6](explications_readme.md)).
...
([explications §5](explications_readme.md)), là où l'état de l'art est PPO (clipping, GAE,
...
> [explications_readme.md](explications_readme.md) pour l'algorithme sous-jacent.
>
