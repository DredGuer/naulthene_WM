...
"""
Naulthène AGI — package racine.

Regroupe le cerveau (`cerveau`), les salles de classe / cursus
(`salles_de_classe`), la Cuve persistante client-serveur (`cuve`), l'hémisphère
